...
class Auth(Action):
    ...
    def _auth_to(self):
        try:
            ...
            # if frame_response.data[1] == 0x67 and frame_response.data[2] == 0x01 and
            # frame_response.data[3] == 0x00:
            if frame_response.data[1] == 0x67 and frame_response.data[2] == 0x01 and len(
                    frame_response.data) == len([0x02, 0x67, 0x01]):
