...
#define DEV_LOOP_PARTITION_1_ADDRESS_START 2048
#define DEV_LOOP_PARTITION_1_ADDRESS_END 206847
#define DEV_LOOP_PARTITION_1_SECTORS ((DEV_LOOP_PARTITION_1_ADDRESS_END - DEV_LOOP_PARTITION_1_ADDRESS_START) + 1)
#define DEV_LOOP_PARTITION_1_SIZE (DEV_LOOP_PARTITION_1_SECTORS * SECTOR_SIZE)

#define DEV_LOOP_PARTITION_2_ADDRESS_START 206848
#define DEV_LOOP_PARTITION_2_ADDRESS_END 407552
